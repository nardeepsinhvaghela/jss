...
class Frag_WL_DashBoard extends StatefulWidget {
  @override
  _Frag_WL_DashBoardState createState() => _Frag_WL_DashBoardState();
}

class _Frag_WL_DashBoardState extends State<Frag_WL_DashBoard> {
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Row(
                                      children: <Widget>[
                                        ImageIcon(
                                          AssetImage("ic_rupee_indian.png"),
                                          size: 16.0,
                                        ),
                                        Text(
                                          "150000",
